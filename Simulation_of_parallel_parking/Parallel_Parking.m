...
x_d=-9.999;
y=-10; %The strating Y coordinate of the vehicle
y_d=45;
...
theta_d=theta_d+delta_theta_d;
  x_seq(i) = x; %store x coordinate to x sequence
...
plot (x, y, 'rs');
plot (x_d, y_d, 'w');
axis([-20 160 -20 100]); %show coordinate in the figure
xlabel('x - cm');
ylabel('y - cm');
...
h1 = line([-20 55.5], [60 60]);
h2 = line([55.5 56], [60 85]);
h3 = line([55.5 92], [85 85]);
h4 = line([92 92], [60 85]);
h5 = line([92 160], [60 60]);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%Oblique upper rear straight%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
x=1.156670936131712e+02; 
y=-10; 
theta=-0.443953741391700; 
phi=0;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%Oblique upper front straight%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

x=88.87; 
y=24.235; 
theta=0.438764951587649; 
phi=0; 
